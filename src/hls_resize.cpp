...
int hls_resize::initial(const char* xclbin_path)
{
    xuid_t uuid;
...
void hls_resize::set(const unsigned int in_row, const unsigned int in_col, const unsigned int out_row, const unsigned int out_col)
{
    in_width = in_row;
    in_height = in_col;
    out_width = out_row;
